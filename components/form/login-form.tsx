...
//           <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 rtl">
//             <div className="flex flex-col gap-6">
//               <div className="flex flex-col items-center text-center">
//                 <h1 className="text-2xl mb-3 font-bold">مرحبًا بعودتك</h1>
//               </div>
...
//                   {...register("email")}
//                   dir="ltr"
//                   className="w-full px-3 py-2 text-right border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
//                 />
...
//                     كلمة المرور
//                   </label>
//                   <Link href="#" className="text-sm underline-offset-2 hover:underline text-purple-700">
//                     نسيت كلمة المرور؟
//                   </Link>
//                 </div>
//                 <input
...
//               <button
//                 type="submit"
//                 className="w-full bg-purple-700 hover:bg-purple-700 disabled:bg-purple-400 text-white font-medium py-2 px-4 rounded-md transition-colors"
//                 disabled={isLoading}
//               >
//                 {isLoading ? "جاري تسجيل الدخول..." : "تسجيل الدخول"}
//               </button>
...
//         بالنقر فوق متابعة، فإنك توافق على <Link href="#">شروط الخدمة</Link> و <Link href="#">سياسة الخصوصية</Link>{" "}
//         الخاصة بنا.
//       </div>
//     </div>
//   )
...
import { refreshAuthToken } from "@/app/api/refreshAuthToken"
import { useRouter } from "next/navigation"
import  { changeTitleLogin }  from "@/features/auth/authSlice" 
...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const LoadingOverlay = () => (
    <div className="fixed inset-0  flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-sm mx-4 text-center">
        <div className="animate-spin rounded-full h-24 w-24 border-b-2 border-purple-700 mx-auto mb-4"></div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">جاري التحقق من الجلسة</h3>
        <p className="text-sm text-gray-600">يرجى الانتظار بينما نتحقق من بياناتك...</p>
      </div>
    </div>
  )
  ...
  return (
    <>
      {isRefreshingToken && <LoadingOverlay />}
      <div className={`flex flex-col gap-6 ${className || ""}`} {...props}>
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden p-0">
          <div className="grid p-0 md:grid-cols-2">
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 rtl">
              <div className="flex flex-col gap-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-purple-700 hover:bg-purple-800 disabled:bg-purple-400 text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center justify-center"
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button
                    type="button"
                    className="w-full border border-gray-300 hover:bg-gray-50 py-2 px-4 rounded-md transition-colors flex items-center justify-center disabled:opacity-50"
                    disabled={isRefreshingToken}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
                      <path
