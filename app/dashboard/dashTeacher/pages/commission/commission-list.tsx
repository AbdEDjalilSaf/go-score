...
//           <h2 className="text-xl font-semibold text-gray-800">معلومات العمولة</h2>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className=" bg-gray-50">
                  ...
                  <th className="px-3 py-4 text-center font-semibold text-gray-600 text-sm border-b border-gray-200"></th>
                </tr>
              </thead>
              <tbody>
                {currentStudents.map((student: Student) => (
