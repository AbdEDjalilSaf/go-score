        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <Link href="/admin/login" className="text-primary-foreground/80 hover:text-primary-foreground text-sm">
              <li className="text-primary-foreground/80 text-sm"> تسجيل الدخول ك Admin</li>
              </Link>
            </ul>
          </div>
          <div className="space-y-4">
